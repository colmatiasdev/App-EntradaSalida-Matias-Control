...
(function () {
  ...
  function pintarTablaCompras(datos) {
    ...
    theadEl.innerHTML = '<tr><th>HORA</th><th>NOMBRE-APELLIDO</th><th>PRODUCTO</th><th class="th-num">CANT.</th><th class="th-num">MONTO</th></tr>';
    tbodyEl.innerHTML = '';
    var total = 0;
    datos.forEach(function (r) {
      ...
      tbodyEl.innerHTML +=
        ...
        '<td class="td-num">' + formatImporte(monto || 0) + '</td></tr>';
    });
    tfootEl.innerHTML = '<tr><td colspan="4"><strong>Total Compras Panadería</strong></td><td class="td-num td-total">' + formatImporte(total) + '</td></tr>';
  }
  ...
  function pintarTablaVentas(datos) {
    ...
    tfootEl.innerHTML = '<tr><td colspan="4"><strong>Total Ventas Market</strong></td><td class="td-num td-total">' + formatImporte(total) + '</td></tr>';
  }
  ...
  function pintarTablaGastos(datos) {
    ...
    theadEl.innerHTML = '<tr><th>HORA</th><th>TIPO-OPERACION</th><th>DESCRIPCION</th><th class="th-num">IMPORTE</th></tr>';
    tbodyEl.innerHTML = '';
    var total = 0;
    datos.forEach(function (r) {
      ...
      tbodyEl.innerHTML +=
        ...
        '<td class="td-num">' + formatImporte(imp || 0) + '</td></tr>';
    });
    tfootEl.innerHTML = '<tr><td colspan="3"><strong>Total Gastos de Salida</strong></td><td class="td-num td-total">' + formatImporte(total) + '</td></tr>';
  }
  ...
  function cargarDatos() {
    ...
    fetch(url, {
      ...
      .then(function (data) {
        ...
        pintarTablaCompras(data.comprasPanaderia || []);
        pintarTablaVentas(data.ventasMarket || []);
        pintarTablaGastos(data.gastosSalida || []);
      })
      .catch(function (err) {
        setCargando(false);
